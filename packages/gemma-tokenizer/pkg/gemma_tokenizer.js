 ...
 * @param {string} json
 */
module.exports.init_from_json = function(json) {
    const ptr0 = passStringToWasm0(json, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    const ret = wasm.init_from_json(ptr0, len0);
    if (ret[1]) {
 ...
 * @returns {number}
 */
module.exports.count = function(text) {
...
const path = require('path').join(__dirname, 'gemma_tokenizer_bg.wasm');
