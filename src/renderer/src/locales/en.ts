  ...
  translation: {
    ...
    settings: {
      ...
      apiKey: {
        ...
        description: 'An API key is required to use Gemini AI translation.',
        current: 'Current API Key',
        notSet: 'API key is not set. Please enter an API key to use translation features.',
        ...
        loadFailed: 'Failed to load API key settings.',
        saveFailed: 'Failed to save API key.',
        deleteFailed: 'Failed to delete API key.',
        validateFailed: 'Failed to validate API key.',
        getKeyHint: "Don't have an API key? Get one for free at:",
      },
