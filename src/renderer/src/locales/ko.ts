export default {
  translation: {
    ...
    settings: {
      ...
      apiKey: {
        title: 'Gemini API 키',
        description: 'Gemini AI 번역을 사용하려면 API 키가 필요합니다.',
        current: '현재 API 키',
        notSet: 'API 키가 설정되지 않았습니다. 번역 기능을 사용하려면 API 키를 입력하세요.',
        inputLabel: '새 API 키',
        placeholder: 'AIza...',
        save: '저장',
        update: '변경',
        ...
        loadFailed: 'API 키 설정을 불러오는데 실패했습니다.',
        saveFailed: 'API 키 저장에 실패했습니다.',
        deleteFailed: 'API 키 삭제에 실패했습니다.',
        validateFailed: 'API 키 검증에 실패했습니다.',
        getKeyHint: 'API 키가 없으신가요? 여기서 무료로 발급받을 수 있습니다:',
      },
